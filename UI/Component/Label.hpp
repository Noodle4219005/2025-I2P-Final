...
namespace Engine {
    ...
    public:
        ...
        explicit Label(const std::string &text, const std::string &font, int fontSize, double x, double y, unsigned char r = 0, unsigned char g = 0, unsigned char b = 0, unsigned char a = 255, double anchorX = 0, double anchorY = 0);
        /// <summary>
